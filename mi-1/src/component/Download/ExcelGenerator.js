...
export const downloadExcel = async (enquirieNo, customerName, customerRefNo, kAMName, profileName, sampleImage, profileNo, twoD,threeD,machine,tools,fixture,click1,click4, shortRadiusBendingRadius, click5, longRadiusBendingRadius, click2,laserCuttingLength, click3, powderCoatingLength, holePunching, holePunchingDetails, assemblyProcess, assemblyProcessDetails, click6, outsourceActivity, material, materialIndianEquiv, tolerance, customerSpecReq, packingSpc, sample, volumeMonthly, volumeMonthlyInTon, volumeYearly, volumeYearlyInTon, spare, reason, statuttery, unstared, unstaredval, risk, riskReason, result, unit1, unit2, type, stripWidth, thickness, boxPerimeter, length, enquirieDate, reviewDate) => {
  ...
  worksheet.addRow(["", "Post Forming process", "", "", "", "Bending", "Short Radius", "Radius(mm)", !click4 ? "" : shortRadiusBendingRadius, "", "", "", ""]);
  worksheet.addRow(["", "", "", "", "", "", "", "Thickness (mm)", !click4 ? "" : thickness, "", "", "", ""]);
  worksheet.addRow(["", "", "", "", "", "", "Long Radius", "Radius(mm)", !click5 ? "" : longRadiusBendingRadius, "", "", "", ""]);
  worksheet.addRow(["", "", "", "", "", "", "", "Thickness (mm)", !click5 ? "" : thickness, "", "", "", ""]);
  worksheet.addRow(["", "", "", "", "", "Laser cutting", "", "Length(mm)", !click2 ? "" : laserCuttingLength, "", "", "", ""]);
  worksheet.addRow(["", "", "", "", "", "", "", "Thickness (mm)", !click2 ? "" : thickness, "", "", "", ""]);
  worksheet.addRow(["", "", "", "", "", "Powder coating", "", "Length(mm)", !click3 ? "" : powderCoatingLength, "", "", "", ""]);
  ...
  worksheet.eachRow((Row, rowNumber) => {
    Row.eachCell((Cell, colNumber) => {
      ...
      // Green (Feasible)
      if (value === "FEASIBLE" ||value === "Available" || value === "Not Required" || value === "Low" || value === "Achivable" || value === "Greater than 0.5" || (cell === "I39" && value === "No") || (cell === "I38" && (value === "Yes, & Complied" || value === "No")) || (cell === "I37" && value === "Yes") || value === "MI Standard" || (cell === "I29" && value === "No") || (cell === "I30" && value === "No") || (cell === "I16" && (type === "Open" && (stripWidth > 10 && stripWidth <= 220))) || (cell === "I17" && (type === "Open" && (thickness > 0.4 && thickness <= 4))) || (cell === "I19" && (type === "Close" && (stripWidth > 10 && stripWidth <= 350))) || (cell === "I20" && (type === "Close" && (thickness > 0.8 && thickness <= 4))) || (cell === "I22" && click1 && click4 && (shortRadiusBendingRadius > 40 && shortRadiusBendingRadius <=400)) || (cell === "I23" && click1 && click4 && (thickness > 0.8 && thickness <= 6)) || (cell === "I24" && click1 && click5 && (longRadiusBendingRadius > 400 && longRadiusBendingRadius <= 10000)) || (cell === "I25" && click1 && click5 && (thickness > 40 && thickness <=400)) || (cell === "I26" && click2 && (laserCuttingLength > 10 && laserCuttingLength <=3000)) || (cell === "I27" && click2 && (thickness > 0.8 && thickness <=10)) || (cell === "I28" && click3 && (powderCoatingLength > 200 && powderCoatingLength <= 3000))) {
      ...
      // Red (Not Feasible)
      else if (value === "NOT FEASIBLE" ||value === "Not Available" || value === "High" || value === "Essential to proceed" || value === "Regret" || value === "Less than 0.1" || value === "Not Achivable" || (cell === "I38" && value === "Cannot comply") || (cell === "I16" && (type === "Open" && (stripWidth <= 10 || stripWidth > 220))) || (cell === "I17" && (type === "Open" && (thickness <= 0.4 || thickness > 4))) || (cell === "I19" && (type === "Close" && (stripWidth <= 10 || stripWidth > 350))) || (cell === "I20" && (type === "Close" && (thickness <= 0.8 || thickness > 4))) || (cell === "I22" && click1 && click4 && (shortRadiusBendingRadius <= 40 || shortRadiusBendingRadius > 400)) || (cell === "I23" && click1 && click4 && (thickness <= 0.8 || thickness > 6)) || (cell === "I24" && click1 && click5 && (longRadiusBendingRadius <= 400 || longRadiusBendingRadius > 10000)) || (cell === "I25" && click1 && click5 && (thickness <= 400 || thickness > 10000)) || (cell === "I26" && click2 && (laserCuttingLength <= 10 || laserCuttingLength > 3000)) || (cell === "I27" && click2 && (thickness <= 0.8 || thickness > 10)) || (cell === "I28" && click3 && (powderCoatingLength <= 200 || powderCoatingLength > 3000))) {
