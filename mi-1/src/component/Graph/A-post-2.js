  ...
  return (
    <div style={{ position: 'relative' }}>
      ...
      {points.map((point, index) => (
        ...
        {/* L Shape */}
        <rect x={50 + outerRadius + side3} y={150 - thickness} width={side4 - 2*outerRadius} height={thickness} fill="black"/>
        <rect x={50 + side3 + side4 - thickness} y={150 - side5 + radius/Math.tan(aa*angle1/2)} width={thickness} height={side5 - outerRadius - radius/Math.tan(aa*angle1/2)} fill="black"/>
        <rect x={50 + side3} y={150 - side2 + outerRadius - thickness} width={thickness} height={side2 - 2*outerRadius + thickness} fill="black"/>
        ...
        <CircleSector radius={outerRadius} centerX={50 + outerRadius} centerY={150 - side2 - outerRadius} angle={90} rotation={90} thickness={thickness}/>
        <CircleSector radius={outerRadius} centerX={50 + side3 - outerRadius + thickness} centerY={150 - side2 + outerRadius - thickness} angle={90} rotation={270} thickness={thickness}/>
        <CircleSector radius={outerRadius} centerX={50 + side3 + outerRadius} centerY={150 -  outerRadius} angle={90} rotation={90} thickness={thickness}/>
        <CircleSector radius={outerRadius} centerX={50 + side3 + side4 - outerRadius} centerY={150 - outerRadius} angle={90} rotation={0} thickness={thickness}/>
        <CircleSector radius={radius} centerX={50 + side3 + side4 - radius} centerY={150 - side5 + radius/Math.tan(aa*angle1/2)} angle={180 - angle1} rotation={angle1 - 180} thickness={thickness}/>
        <CircleSector radius={outerRadius} centerX={x3} centerY={y3} angle={180 - angle2} rotation={angle1 + angle2} thickness={thickness}/>
        <CircleSector radius={outerRadius} centerX={x2} centerY={y2} angle={180 - angle4} rotation={ - angle3 + angle4} thickness={thickness}/>

        {/* Vertical Arrow for A */}
        <Liney x1={45} x2={45} y1={150 - side2 - side1} y2={150 - side2} text={'A'} val={side11} textHeight={-17}/>

        {/* Vertical Arrow for B */}
        <Liney x1={45} x2={45} y1={150 - side2} y2={150} text={'B'} val={side22} textHeight={-17}/>

        {/* Vertical Arrow for E */}
        <Liney x1={55 + side3 + side4} x2={55 + side3 + side4} y1={150 - side5 - side6} y2={150 - side5} text={'F'} val={side66} textHeight={17}/>

        {/* Vertical Arrow for A */}
        <Liney x1={55 + side3 + side4} x2={55 + side3 + side4} y1={150 - side5} y2={150} text={'E'} val={side55} textHeight={17}/>

        {/* Vertical Arrow for B */}
        <Linex x1={50} x2={50 + side3} y1={155} y2={155} text={'C'} val={side33} textHeight={5} unit={""}/>

        {/* Vertical Arrow for B */}
        <Linex x1={50 + side3} x2={50 + side3 + side4} y1={155} y2={155} text={'D'} val={side44} textHeight={5} unit={""}/>
