...
function Bus_body_section_graph({ side11, side22,side33, side44, side55, thickness1, outerRadius1, sendValue}) {
  ...
  const predefinedPoints = [
    { id: 1, type: 'line', x: 50 + outerRadius, y: 150 - thickness, w: side3 - 2 * outerRadius, h: thickness, angle: 0 },
    ...
    { id: 4, type: 'line', x: 50 + side3 - thickness, y: 150 - side4 + outerRadius * Math.tan(angle / 2), w: thickness, h: side4 - outerRadius - outerRadius * Math.tan(angle / 2), angle: 0 },
    { id: 5, type: 'line', x: 50 + side2 - thickness, y: 150 - side1 + outerRadius, w: thickness, h: side5 - outerRadius - outerRadius * Math.tan(angle / 2), angle: 0 },
    { id: 6, type: 'line', x: 50 + side2 - thickness + outerRadius - (outerRadius - thickness) * Math.cos(angle), y: 150 - side1 + side5 - outerRadius * Math.tan(angle / 2) + (outerRadius - thickness) * Math.sin(angle), w: l, h: thickness, angle: 90 - aa * angle},
    ...
    { id: 10, type: 'circle', x: 50 + side2 + outerRadius - thickness, y: 150 - side1 + side5 - outerRadius * Math.tan(angle / 2), r: outerRadius, angle: angle * aa, rotation: 180 - angle * aa, t: thickness },
    { id: 11, type: 'circle', x: 50 + side3 - outerRadius, y: 150 - side4 + outerRadius * Math.tan(angle / 2), r: outerRadius, angle: angle * aa, rotation: 0 - angle * aa, t: thickness },
    { id: 12, type: 'circle', x: 50 + side3 - outerRadius, y: 150 - outerRadius, r: outerRadius, angle: 90, rotation: 0, t: thickness },
  ];
  ...
  return (
    <div style={{ position: 'relative' }}>
      ...
      >
        ...
        <rect x={50 + side3 - thickness + 100 - a} y={150 - side4 + outerRadius*Math.tan(angle/2) + 100 - b} width={thickness} height={side4 - outerRadius - outerRadius*Math.tan(angle/2)} fill="black" />
        <rect x={50 + side2 - thickness + 100 - a} y={150 - side1 + outerRadius + 100 - b} width={thickness} height={side5 - outerRadius - outerRadius*Math.tan(angle/2)} fill="black" />
        <LineAtTheta x={50 + side2 - thickness + outerRadius - (outerRadius - thickness)*Math.cos(angle) + 100 - a} y={150 - side1 + side5 - outerRadius*Math.tan(angle/2) + (outerRadius - thickness)*Math.sin(angle) + 100 - b} w={l} h={thickness} angle={90 - aa*angle}/>
        ...
        <CircleSector radius={outerRadius} centerX={50 + side2 + outerRadius - thickness + 100 - a} centerY={150 - side1 + side5 - outerRadius*Math.tan(angle/2) + 100 - b} angle={angle*aa} rotation={180 - angle*aa} thickness={thickness}/>
        <CircleSector radius={outerRadius} centerX={50 + side3 - outerRadius + 100 - a} centerY={150 - side4 + outerRadius*Math.tan(angle/2) + 100 - b} angle={angle*aa} rotation={0 - angle*aa} thickness={thickness}/>
        ...
        <Liney x1={55 + side2 + 100 - a} x2={55 + side2 + 100 - a} y1={150 - side1 + 100 - b} y2={150 - side1 + side5 + 100 - b} text={'E'} val={side55} textHeight={17}/>
