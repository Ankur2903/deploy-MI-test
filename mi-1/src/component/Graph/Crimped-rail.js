...
function Crimped_rail_graph({ thickness1, side11, side22, side33, side44, outerRadius1}) {
  ...
  return (
      ...
      >
        ...
        <rect x={50 + outerRadius} y={150 - side2} width={side1 - 2*outerRadius} height={thickness} fill="black" />
        <rect x={50} y={150 - side4 + outerRadius} width={thickness} height={side4 - 2*outerRadius} fill="black" />
        <rect x={50 + outerRadius} y={150 - side4} width={side1 - 2*outerRadius - thickness} height={thickness} fill="black" />
        ...
        <CircleSector radius={outerRadius} centerX={50 + side1 - outerRadius} centerY={150 - side2 + outerRadius} angle={90} rotation={270} thickness={thickness}/>
        <CircleSector radius={outerRadius} centerX={50 + outerRadius} centerY={150 - side2 + outerRadius} angle={180} rotation={90} thickness={thickness}/>
        <CircleSector radius={outerRadius} centerX={50 + outerRadius} centerY={150 - side4 + outerRadius} angle={90} rotation={180} thickness={thickness}/>
        <CircleSector radius={outerRadius} centerX={50 + side1 - outerRadius - thickness} centerY={150 - side4 - outerRadius + thickness} angle={180} rotation={270} thickness={thickness}/>
        ...
        {/* Horizontal Arrow for Width */}
        <Linex x1={50 + side1 - side3 - thickness} x2={50 + side1 - thickness} y1={145 - side2} y2={145 - side2} text={'C'} val={side11} textHeight={-5}/>
