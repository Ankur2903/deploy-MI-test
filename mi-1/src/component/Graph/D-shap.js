...
function D_shap_graph({ thickness1, side11, side22, outerRadius1, sendValue}) {
  ...
  return (
      ...
      <svg
        viewBox={viewBox}
        style={{ width: '100%', side2: 'auto', backgroundColor: '#f9f9f9', border: '1px solid #ccc' }}
