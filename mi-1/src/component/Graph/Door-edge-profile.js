...
function Door_edge_profile_graph({ side11, side22, side33, side44, thickness1, outerRadius1, sendValue}) {
  ...
  const predefinedPoints = [
    ...
    { id: 3, type: 'line', x: 50 + side2 - thickness, y: 150 - side4 + outerRadius, w: thickness, h: side4 - 2 * outerRadius, angle: 0 },
    { id: 4, type: 'line', x: 50 + side2 + outerRadius - thickness, y: 150 - side4, w: side3 - outerRadius + thickness, h: thickness, angle: 0 },
    ...
    { id: 7, type: 'circle', x: 50 + side2 + outerRadius - thickness, y: 150 - side4 + outerRadius, r: outerRadius, angle: 90, rotation: 180, t: thickness },
  ];
  ...
  return (
    <div style={{ position: 'relative' }}>
      ...
      >
        ...
        <rect x={50 + side2 + outerRadius - thickness + 100 - a} y={150 - side4 + 100 - b} width={side3 - outerRadius + thickness} height={thickness} fill="black" />
        ...
        <Liney x1={55 + side2 + side3 + 100 - a} x2={55 + side2 + side3 + 100 - a} y1={150 - side4 + 100 - b} y2={150 + 100 - b} text={'D'} val={side44} textHeight={17} />
