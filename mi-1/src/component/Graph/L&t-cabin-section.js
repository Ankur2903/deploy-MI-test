  ...
  return (
    <div style={{ position: 'relative' }}>
      ...
      >
        ...
        <rect x={50 + side1 -  thickness} y={150 - side2 + side4 + outerRadius - thickness} width={thickness} height={side2 - side4 - 2*outerRadius + thickness} fill="black" />
        
        <rect x={50 + side1 - side3 + radius*Math.tan(angle/2)} y={150 - side2 + side4 - thickness} width={side3 - outerRadius - radius*Math.tan(angle/2)} height={thickness} fill="black" />

        <rect x={50} y={150 - side2 + radius1} width={thickness} height={side2 - radius1 - outerRadius} fill="black" />
        <rect x={50 + radius1} y={150 - side2} width={side5 - radius*Math.tan(angle/2) - radius1} height={thickness} fill="black" />
       
        <LineAtTheta x = {50 + side5 + radius*Math.tan(angle/2)*Math.cos(angle)} y = {150 - side2 + radius*Math.tan(angle/2)*Math.sin(angle)} w = {l} h = {thickness} angle={aa*angle}/>
        ...
        <CircleSector radius={outerRadius} centerX={50 + side1 - outerRadius} centerY={150 - side2 + side4 + outerRadius - thickness} angle={90} rotation={270} thickness={thickness}/>

        <CircleSector radius={radius} centerX={50 + side1 - side3 + radius*Math.tan(angle/2)} centerY={150 - side2 + side4 - radius} angle={aa*angle} rotation={90} thickness={thickness}/>

        <CircleSector radius={radius1} centerX={50 + radius1} centerY={150 - side2  + radius1} angle={90} rotation={180} thickness={thickness}/>

        <CircleSector radius={radius} centerX={50 + side5 - radius*Math.tan(angle/2)} centerY={150 - side2 + radius} angle={aa*angle} rotation={270} thickness={thickness}/>
        ...
        <Linex x1={50} x2={50 + side5} y1={145 - side2} y2={145 - side2} text={'E'} val={side55} textHeight={-5}/>

        {/* Vertical Arrow for side2 */}
        <Liney x1={55 + side1} x2={55 + side1} y1={150 - side2} y2={150} text={'B'} val={side22} textHeight={17}/>

        {/* Vertical Arrow for side2 */}
        <Liney x1={50 + side1 - side3} x2={50 + side1 - side3} y1={155 - side2 + side4} y2={155 - side2 + side4} text={'R2'} val={radius22} textHeight={-17}/>

        {/*Vertical Arrow for side4 */}
        <Liney x1={165} x2={165} y1={150 - side2} y2={150 - side2 + side4} text={'D'} val={side44} textHeight={17}/>

        {/* Vertical Arrow for side2 */}
        <Liney x1={45} x2={45} y1={150 - side2} y2={150 - side2 + radius1} text={'R1'} val={radius11} textHeight={-17}/>
