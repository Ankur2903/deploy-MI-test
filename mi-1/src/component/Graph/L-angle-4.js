...
function L_angle_4_graph({ thickness1, side11, side22, side33, side44, side55, side66, outerRadius1, sendValuex, sendValuey, lAngleGraphRef}) {
  ...
  return (
      ...
      >
        ...
        {/* L Shape */}
        <rect x={50 + side3 - thickness} y={150 - side1 - side5 + thickness} width={thickness} height={side5 - outerRadius} fill="black"/>
        ...
        <rect x={50 + side2 + outerRadius - thickness} y={150 - side4} width={side6 - outerRadius} height={thickness} fill="black"/>
        
        
        <CircleSector radius={outerRadius} centerX={50 + side3 - outerRadius} centerY={150 - side1 - outerRadius + thickness} angle={90} rotation={0} thickness={thickness}/>
        ...
        <Liney x1={55 + side3} x2={55 + side3} y1={150 - side1 - side5 + thickness} y2={150 - side1 + thickness} text={'E'} val={side55} textHeight={17}/>Arrow for side6
        ...
        <Linex x1={50 + side2 - thickness} x2={50 + side2 + side6  - thickness} y1={145 - side4} y2={145 - side4} text={'F'} val={side66} textHeight={-5}/>{/*Arrow for sid4 */}
