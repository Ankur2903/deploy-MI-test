...
function Rectangle_graph({ side1, side2, thickness1, outerRadius1}) {
  ...
  return (
    <div style={{ position: 'relative' }}>
      ...
      >
        ...
        {/* rectangle Shape */}
        <rect x={50 + (100 - sidex)/2} y={50 + outerRadius+ (100  - sidey)/2} width={thickness} height={sidey-2*outerRadius} fill="black" />
        <rect x={50 + sidex - thickness + (100 - sidex)/2} y={50 + outerRadius+ (100  - sidey)/2} width={thickness} height={sidey-2*outerRadius} fill="black" />
        ...
        <Linex x1={50  + (100 - sidex)/2} x2={thickness + 50  + (100 - sidex)/2} y1={45+ (100  - sidey)/2} y2={45+ (100  - sidey)/2} text={'t'} val={thickness1} textHeight={-5}/>
