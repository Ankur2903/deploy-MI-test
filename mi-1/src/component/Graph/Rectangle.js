...
function Rectangle_graph({ side1, side2, thickness1, outerRadius1, sendValue}) {
  ...
  const predefinedPoints = [
    { id: 1, type: 'line', x: 50 + (100 - sidex)/2, y: 50 + outerRadius + (100 - sidey)/2, w: thickness, h: sidey - 2 * outerRadius, angle: 0 },
    { id: 2, type: 'line', x: 50 + sidex - thickness + (100 - sidex)/2, y: 50 + outerRadius + (100 - sidey)/2, w: thickness, h: sidey - 2 * outerRadius, angle: 0 },
    { id: 3, type: 'line', x: 50 + outerRadius + (100 - sidex)/2, y: 50 + sidey - thickness + (100 - sidey)/2, w: sidex - 2 * outerRadius, h: thickness, angle: 0 },
    { id: 4, type: 'line', x: 50 + outerRadius + (100 - sidex)/2, y: 50 + (100 - sidey)/2, w: sidex - 2 * outerRadius, h: thickness, angle: 0 },
    { id: 5, type: 'circle', x: 50 + outerRadius + (100 - sidex)/2, y: 50 + sidey - outerRadius + (100 - sidey)/2, r: outerRadius, angle: 90, rotation: 90, t: thickness },
    ...
    { id: 8, type: 'circle', x: 50 + sidex - outerRadius + (100 - sidex)/2, y: 50 + sidey - outerRadius + (100 - sidey)/2, r: outerRadius, angle: 90, rotation: 0, t: thickness },
  ];
  ...
  return (
    <div style={{ position: 'relative' }}>
      ...
      >
        ...
        {/* rectangle Shape */}
        <rect x={50 + (100 - sidex)/2 + 100 - a} y={50 + outerRadius + (100 - sidey)/2 + 100 - b} width={thickness} height={sidey - 2 * outerRadius} fill="black" />
        <rect x={50 + sidex - thickness + (100 - sidex)/2 + 100 - a} y={50 + outerRadius + (100 - sidey)/2 + 100 - b} width={thickness} height={sidey - 2 * outerRadius} fill="black" />
        <rect x={50 + outerRadius + (100 - sidex)/2 + 100 - a} y={sidey - thickness + 50 + (100 - sidey)/2 + 100 - b} width={sidex - 2 * outerRadius} height={thickness} fill="black" />
        <rect x={50 + outerRadius + (100 - sidex)/2 + 100 - a} y={50 + (100 - sidey)/2 + 100 - b} width={sidex - 2 * outerRadius} height={thickness} fill="black" />

        <CircleSector radius={outerRadius} centerX={50 + outerRadius + (100 - sidex)/2 + 100 - a} centerY={50 + sidey - outerRadius + (100 - sidey)/2 + 100 - b} angle={90} rotation={90} thickness={thickness} />
        ...
        <CircleSector radius={outerRadius} centerX={50 + sidex - outerRadius + (100 - sidex)/2 + 100 - a} centerY={50 + sidey - outerRadius + (100 - sidey)/2 + 100 - b} angle={90} rotation={0} thickness={thickness} />
        ...
        <Linex x1={50 + (100 - sidex)/2 + 100 - a} x2={thickness + 50 + (100 - sidex)/2 + 100 - a} y1={45 + (100 - sidey)/2 + 100 - b} y2={45 + (100 - sidey)/2 + 100 - b} text={'t'} val={thickness1} textHeight={-5} />
