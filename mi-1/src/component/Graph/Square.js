...
function Square_graph({ side1, thickness1, outerRadius1}) {
  const mx = side1;
  const thickness = (thickness1/side1)*100;
  const side = 100;
  const outerRadius = (outerRadius1/side1)*100;
  ...
  return (
    <div style={{ position: 'relative' }}>
      ...
      >
        ...
        {/* Draw X and Y axes */}
        <line x1="-1000" y1={50 + side/2} x2={svgWidth + 1000} y2={50 + side/2} stroke="gray" strokeWidth="1" />
        <line x1={50 + side/2} y1="-1000" x2={50 + side/2} y2={svgHeight + 1000} stroke="gray" strokeWidth="1" />



        {/* square Shape */}
        <rect x={50} y={50 + outerRadius} width={thickness} height={side-2*outerRadius} fill="black" />
        <rect x={50 + side - thickness} y={50 + outerRadius} width={thickness} height={side-2*outerRadius} fill="black" />
        <rect x={50+outerRadius} y={side - thickness + 50} width={side-2*outerRadius} height={thickness} fill="black" />
        ...
        <Liney x1={55 + side} x2={55 + side} y1={50} y2={50 + side} text={'A'} val={side1} textHeight={17}/>

        {/* Horizontal Arrow for Thickness */}
        <Linex x1={50} x2={thickness + 50} y1={45} y2={45} text={'t'} val={thickness1} textHeight={-5}/>
      </svg>
