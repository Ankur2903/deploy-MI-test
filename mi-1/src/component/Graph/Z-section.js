...
function Z_section_graph({ side11, side22,side33,side44, radius1, thickness1, outerRadius1, sendValuey}) {
  ...
  return (
    <div style={{ position: 'relative' }}>
      ...
      >
        ...
        {/* Line Shape */}
        <rect x={50 + side3 - side2 + outerRadius} y={150 - thickness} width={side2 - outerRadius - radius} height={thickness} fill="black" />
        <rect x={50 + side3 - side2} y={150 - side1 + side4 + outerRadius - thickness} width={thickness} height={side1 - side4 - outerRadius - outerRadius + thickness} fill="black" />
        <rect x={50 + radius} y={150 - side1} width={side2 - outerRadius - radius} height={thickness} fill="black" />
        <rect x={50 + side2 - thickness} y={150 - side1 + outerRadius} width={thickness} height={side1 - 2*outerRadius + thickness - 2*radius} fill="black" />
        ...
        {/* outer radius */}
        <CircleSector radius={outerRadius} centerX={50 + side3 - side2 + outerRadius} centerY={150 - outerRadius} angle={90} rotation={90} thickness={thickness}/>
        ...
        <CircleSector radius={outerRadius} centerX={50 + side3 - side2 -outerRadius + thickness} centerY={150 - side1 + side4 + outerRadius - thickness} angle={90} rotation={270} thickness={thickness}/>
