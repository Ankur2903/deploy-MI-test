  ...
  return (
    <>
        {predefinedPoints.map((point) => (
          <circle key={point.id} cx={0 + point.x} cy={0 + point.y} r={thickness} fill={selectedIds.includes(point.id) ? 'green' : 'red'} style={{ cursor: 'pointer' }} onClick={() => handlePointClick(point.id)}/>
        ))}
        ...
        {selectedIds.length === 2 && (() => {
          ...
          return (
            <>
              <line x1={p1.x} y1={p1.y} x2={p2.x} y2={p2.y} stroke="green" strokeWidth={thickness/2}/>
              ...
              <line x1={p1.x} y1={p1.y} x2={p2.x} y2={p1.y} stroke="green" strokeWidth={thickness/2} />
              ...
              <line x1={p2.x} y1={p2.y} x2={p2.x} y2={p1.y} stroke="green" strokeWidth={thickness/2} />
