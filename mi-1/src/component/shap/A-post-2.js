...
function A_post_2({materials}) {
  ...
  const [side2, setSide2] = useState(26);
  ...
  const [angle2, setAngle2] = useState(92);
  const angle2Change = (event) => {
    setAngle2(parseFloat(event.target.value));
  };

  const [angle3, setAngle3] = useState(55);
  ...
  const create3DShapes = () => {
    ...
    shape1.moveTo(side3 + outerRadius, thickness)
    shape1.lineTo(side3 + outerRadius, 0)
    shape1.absarc(side3 + outerRadius, outerRadius, outerRadius, 3*Math.PI/2, Math.PI, true)
    shape1.absarc(side3 - outerRadius + thickness, side2 - outerRadius + thickness, outerRadius - thickness, 0, Math.PI/2, false)
    shape1.absarc(outerRadius, side2 + outerRadius, outerRadius, 3*Math.PI/2, Math.PI, true)
    shape1.absarc(outerRadius, side2 + side1 - outerRadius/Math.tan(aa*angle3/2), outerRadius, Math.PI, aa*angle3, true)
    shape1.absarc(x2, y2, outerRadius - thickness, Math.PI + angle3*aa, angle3*aa - aa*angle4, false)
    shape1.absarc(x3, y3, outerRadius, - aa*(angle1 + angle2), Math.PI - aa*angle1, true)
    ...
    shape1.absarc(x2, y2, outerRadius, angle3*aa - aa*angle4, Math.PI + angle3*aa, true)
    shape1.absarc(outerRadius, side2 + side1 - outerRadius/Math.tan(aa*angle3/2), outerRadius - thickness, aa*angle3, Math.PI, false)
    shape1.absarc(outerRadius, side2 + outerRadius, outerRadius - thickness, Math.PI, 3*Math.PI/2, false)
    shape1.absarc(side3 - outerRadius + thickness, side2 - outerRadius + thickness, outerRadius, Math.PI/2, 0, true)
    shape1.absarc(side3 + outerRadius, outerRadius, outerRadius - thickness, Math.PI, 3*Math.PI/2, false)
    shapes.push(shape1)

    const shape2 = new THREE.Shape();
    shape2.moveTo(side3 + outerRadius, thickness)
    shape2.lineTo(side3 + outerRadius, 0)
    shape2.lineTo(side3 + side4 - outerRadius, 0)
    shape2.lineTo(side3 + side4 - outerRadius, thickness)
    shapes.push(shape2)
