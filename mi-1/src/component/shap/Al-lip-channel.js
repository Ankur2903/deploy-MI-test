...
function Al_lip_channel() {
  ...
  const submitClick = () => {
    setWeightPerLength((7850*(Math.PI*(outerRadius - 0.596*thickness) + 2*Math.PI*thickness + 2*(side2 - outerRadius - thickness) + (side1 - 2*outerRadius)+ 2*(lip - thickness))*thickness*0.000001).toFixed(3));
  ...
  return (
    <div>
      ...
      <div className = "container">
        ...
        <div className='box'>
          <div ref={GraphRef}><Al_lip_channel_graph side1={side1} side2={side2} lip1 = {lip} thickness1={thickness} outerRadius1={outerRadius}  sendValue={handleData}/></div>
        </div>
        <div className='box'>
