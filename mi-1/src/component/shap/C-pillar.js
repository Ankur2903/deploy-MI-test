...
function C_pillar() {
  ...
  const submitClick = () => {
    setWeightPerLenght((7850*((9*Math.PI - 2*aa*(angle1 + angle2 + angle3 + angle4 + angle5))*(outerRadius - 0.596*thickness) +  (side1 - 2*outerRadius/Math.tan(aa*angle1)) + 2*(l1 + l2 + l3 + l4))*thickness*0.000001).toFixed(3));
