...
function C_post() {
  ...
  const [side1, setSide1] = useState(21);
  ...
  const y1 = side2 - outerRadius/Math.tan(aa*angle1/2)
  ...
  const create3DShapes = () => {
    ...
    shape1.absarc(x1, y1, outerRadius, Math.PI, aa*angle1, true)
    shape1.absarc(x2, y2, outerRadius, aa*angle1, aa*(angle1 + angle2) - Math.PI, true)
    shape1.absarc(x3, y3, outerRadius, aa*(angle1 + angle2) - Math.PI, aa*(angle1 + angle2 + angle) - 2*Math.PI , true)
    shape1.absarc(side1 - outerRadius/Math.tan(aa*angle/2), outerRadius, outerRadius, aa*(angle1 + angle2 + angle) - 2*Math.PI, 3*Math.PI/2, true)
    shape1.lineTo(outerRadius, 0)
    shape1.lineTo(outerRadius, thickness)
    shape1.absarc(side1 - outerRadius/Math.tan(aa*angle/2), outerRadius, outerRadius - thickness, 3*Math.PI/2, aa*(angle1 + angle2 + angle) - 2*Math.PI, false)
    shape1.absarc(x3, y3, outerRadius - thickness, aa*(angle1 + angle2 + angle) - 2*Math.PI, aa*(angle1 + angle2) - Math.PI , false)
    shape1.absarc(x2, y2, outerRadius - thickness, aa*(angle1 + angle2) - Math.PI, aa*angle1, false)
    ...
    shape2.absarc(outerRadius ,outerRadius ,outerRadius - thickness,3*Math.PI/2, 2*Math.PI/2,true)
    shape2.lineTo(0, outerRadius)
    shape2.absarc(outerRadius, outerRadius, outerRadius,2*Math.PI/2,3*Math.PI/2, false)
  ...
  const handleDownload = () => {
    ...
    doc.setFontSize(10).setTextColor('black').text(`Side(A): ${side1}   Side(B): ${side2}   Side(C): ${side3}   Side4(D): ${side4}   Angle(Theta1): ${angle1}   Angle(Theta2): ${angle2}   Thickness(t): ${thickness}   Length(L): ${length}`, 6, 30);
  ...
  const submitClick = () => {
    setWeightPerLenght((7850*(2*Math.PI*(outerRadius - 0.596*thickness) + (side1 - outerRadius*(1 + 1/Math.tan(aa*angle3))) + (side2 - outerRadius*(1 + 1/Math.tan(aa*angle1))) + (side3 - outerRadius*(1/Math.tan(aa*angle1/2) + 1/Math.tan(aa*angle2/2))) + (side4 - outerRadius*(1/Math.tan(aa*angle2) + 1/Math.tan(aa*angle))))*thickness*0.000001).toFixed(3));
