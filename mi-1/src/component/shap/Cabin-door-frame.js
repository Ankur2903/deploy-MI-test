...
function Cabin_door_frame() {
  ...
  const submitClick = () => {
    setWeightPerLenght((7850*(Math.PI*(outerRadius - 0.596*thickness) + 2*(Math.PI - aa*angle)*(outerRadius - 0.596*thickness) + 2*(side2 - outerRadius - outerRadius/Math.tan(aa*angle/2)) + (side1 - 2*outerRadius) + 2*(side3 - outerRadius/Math.tan(aa*angle/2)))*thickness*0.000001).toFixed(3));
  ...
  const create3DShapes = () => {
    ...
    shape1.moveTo(0 + thickness*Math.cos(aa*angle), side2 - side3*Math.cos(aa*angle) - thickness*Math.sin(aa*angle))
    shape1.lineTo(0, side2 - side3*Math.cos(aa*angle))
    shape1.absarc(side3*Math.sin(aa*angle) - outerRadius, side2 - outerRadius/Math.tan(aa*angle/2), outerRadius, Math.PI - aa*angle, 0, true)
    shape1.absarc(side3*Math.sin(aa*angle) + outerRadius - thickness, outerRadius, outerRadius - thickness, Math.PI, 3*Math.PI/2, false)
    shape1.absarc(side3*Math.sin(aa*angle) - thickness + side1 - outerRadius, outerRadius, outerRadius - thickness, 3*Math.PI/2, 0, false)
    shape1.absarc(side3*Math.sin(aa*angle) - 2*thickness + side1 + outerRadius, side2 - outerRadius/Math.tan(aa*angle/2), outerRadius, Math.PI, aa*angle, true)
    shape1.lineTo(2*side3*Math.sin(aa*angle) - 2*thickness + side1 , side2 - side3*Math.cos(aa*angle))
    shape1.lineTo(2*side3*Math.sin(aa*angle) - 2*thickness + side1 - thickness*Math.cos(aa*angle), side2 - side3*Math.cos(aa*angle) - thickness*Math.sin(aa*angle))
    shape1.absarc(side3*Math.sin(aa*angle) - 2*thickness + side1 + outerRadius, side2 - outerRadius/Math.tan(aa*angle/2), outerRadius - thickness, aa*angle, Math.PI, false)
    shape1.absarc(side3*Math.sin(aa*angle) - thickness + side1 - outerRadius, outerRadius, outerRadius, 0, 3*Math.PI/2, true)
...
export default Cabin_door_frame;
