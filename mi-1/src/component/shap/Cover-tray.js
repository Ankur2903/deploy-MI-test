...
function Cover_tray({materials}) {
  ...
  const [side3, setSide3] = useState(22);
  const [side4, setSide4] = useState(20);
  const [side5, setSide5] = useState(30);
  ...
  const create3DShapes = () => {
    ...
    shape1.absarc(side1 - outerRadius,side3 - outerRadius, outerRadius - thickness, Math.PI/2, 0, true)
    shape1.absarc(side1 + outerRadius - thickness, outerRadius, outerRadius, Math.PI, 3*Math.PI/2, false)
    shape1.absarc(side1 + side2 - thickness - outerRadius, outerRadius, outerRadius, 3*Math.PI/2, 0, false)
    shape1.absarc(side1 + side2 - 2*thickness, side5 - thickness, thickness, 0, Math.PI, false)
    shape1.lineTo(side1 + side2 - 3*thickness, side5 - side4)
    shape1.lineTo(side1 + side2 - 2*thickness, side5 - side4)
    shape1.lineTo(side1 + side2 - 2*thickness, side5 - thickness)
    shape1.absarc(side1 + side2 - thickness - outerRadius, outerRadius, outerRadius - thickness, 0, 3*Math.PI/2, true)
    shape1.absarc(side1 + outerRadius - thickness, outerRadius, outerRadius - thickness, 3*Math.PI/2, Math.PI, true)
    shape1.absarc(side1 - outerRadius,side3 - outerRadius, outerRadius, 0, Math.PI/2, false)
    ...
    <div>
      ...
      <div className = "container">
        <div className='box'>
          ...
          <div className="container1">
            <lable className="label" htmlFor="side">Side (B) mm</lable>
          ...
          <div className="container1">
            <lable className="label" htmlFor="side">Side (D) mm</lable>
            <input className="input-field" id="side" type="number" value={side4} onChange={side4Change} placeholder="Enter side" />
          </div>
          <div className="container1">
        ...
        <div className='box'>
          <div ref={GraphRef}><Cover_tray_graph side11={side1} side22 = {side2} side33 = {side3} side44 = {side4} side55 = {side5} outerRadius1 = {outerRadius} thickness1 = {thickness}  sendValue={handleData}/></div>
        </div>
        <div className='box'>
