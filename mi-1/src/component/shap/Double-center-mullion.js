...
function Double_center_mullion() {
  ...
  const submitClick = () => {
    setWeightPerLenght((7850*(6*Math.PI*(outerRadius - 0.596*thickness) + 2*(side1 - 6*outerRadius + 2*thickness) + 2*(side4 - 6*outerRadius + thickness))*thickness*0.000001).toFixed(3));
