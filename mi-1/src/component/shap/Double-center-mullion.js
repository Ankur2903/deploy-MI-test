...
import Double_center_mullion_graph from '../Graph/Double-center-mullion';
import Feasibility from '../Feasibility';
import * as Props from '../constant';

function Double_center_mullion() {
  ...
  const submitClick = () => {
    setWeightPerLength((7850*(6*Math.PI*(outerRadius - 0.596*thickness) + 2*(side1 - 6*outerRadius + 2*thickness) + 2*(side4 - 6*outerRadius + thickness))*thickness*0.000001).toFixed(3));

    setTotalWeight((7850*(6*Math.PI*(outerRadius - 0.596*thickness) + 2*(side1 - 6*outerRadius + 2*thickness) + 2*(side4 - 6*outerRadius + thickness))*thickness*0.000001*length).toFixed(3));

    setStripWidth((6*Math.PI*(outerRadius - 0.596*thickness) + 2*(side1 - 6*outerRadius + 2*thickness) + 2*(side4 - 6*outerRadius + thickness)).toFixed(3));

    setOutLine((6*Math.PI*(2*outerRadius - thickness) + 4*(side1 - 6*outerRadius + 2*thickness) + 4*(side4 - 6*outerRadius + thickness)).toFixed(3))

    setArea((thickness*( 2*(side1 - 6*outerRadius + 2*thickness) + 2*(side4 - 6*outerRadius + thickness)) + 3*Math.PI*(Math.pow(outerRadius,2) - Math.pow(outerRadius - thickness,2))).toFixed(3))
  ...
  const create3DShapes = () => {
    ...
    shape1.moveTo(thickness, side1 - side3 - outerRadius)
    shape1.lineTo(0, side1 - side3 - outerRadius)
    shape1.absarc(outerRadius,  side1 - side3 - outerRadius, outerRadius, Math.PI, Math.PI/2, true)
    shape1.absarc(side6 - outerRadius + thickness, side1 - side3 + outerRadius - thickness, outerRadius - thickness, 3*Math.PI/2, 0,false)
    shape1.absarc(side6 + outerRadius, side1 - outerRadius, outerRadius, Math.PI, Math.PI/2, true)
    shape1.absarc(side6 + side5 - outerRadius, side1 - outerRadius, outerRadius, Math.PI/2, 0, true)
    shape1.absarc(side6 + side5 + outerRadius - thickness, side1 - side3 + outerRadius - thickness, outerRadius - thickness, Math.PI, 3*Math.PI/2, false)
    shape1.absarc(side4 - outerRadius, side1 - side3 - outerRadius, outerRadius, Math.PI/2, 0, true)
    shape1.absarc(side4 - outerRadius, side1 - side3 - side2 + outerRadius, outerRadius, 0, 3*Math.PI/2, true)
    shape1.absarc(side6 + side5 + outerRadius - thickness, side1 - side3 - side2 - outerRadius + thickness, outerRadius - thickness, Math.PI/2, Math.PI, false)
    shape1.absarc(side6 + side5 - outerRadius, outerRadius, outerRadius, 0, 3*Math.PI/2, true)
    shape1.absarc(side6 + outerRadius, outerRadius, outerRadius, 3*Math.PI/2, Math.PI, true)
    shape1.absarc(side6- outerRadius + thickness, side1 - side3 - side2 - outerRadius + thickness, outerRadius - thickness, 0, Math.PI/2, false)
    shape1.absarc(outerRadius, side1 - side3 - side2 + outerRadius, outerRadius, 3*Math.PI/2, Math.PI, true)
    shape1.lineTo(thickness,  side1 - side3 - side2 + outerRadius)////////////
    shape1.absarc(outerRadius, side1 - side3 - side2 + outerRadius, outerRadius - thickness, Math.PI, 3*Math.PI/2, false)
    shape1.absarc(side6- outerRadius + thickness, side1 - side3 - side2 - outerRadius + thickness, outerRadius, Math.PI/2, 0, true)
    shape1.absarc(side6 + outerRadius, outerRadius, outerRadius - thickness, Math.PI, 3*Math.PI/2, false)
    shape1.absarc(side6 + side5 - outerRadius, outerRadius, outerRadius - thickness, 3*Math.PI/2, 0, false)
    shape1.absarc(side6 + side5 + outerRadius - thickness, side1 - side3 - side2 - outerRadius + thickness, outerRadius, Math.PI, Math.PI/2, true)
    shape1.absarc(side4 - outerRadius, side1 - side3 - side2 + outerRadius, outerRadius - thickness,  3*Math.PI/2,0, false)
    shape1.absarc(side4 - outerRadius, side1 - side3 - outerRadius, outerRadius - thickness, 0, Math.PI/2, false)
    shape1.absarc(side6 + side5 + outerRadius - thickness, side1 - side3 + outerRadius - thickness, outerRadius, 3*Math.PI/2, Math.PI, true)
    shape1.absarc(side6 + side5 - outerRadius, side1 - outerRadius, outerRadius - thickness, 0, Math.PI/2, false)
    shape1.absarc(side6 + outerRadius, side1 - outerRadius, outerRadius - thickness, Math.PI/2, Math.PI, false)
    ...
    shape2.moveTo(0,side1 - side3 - outerRadius)
    shape2.lineTo(thickness, side1 - side3 - outerRadius)
    shape2.lineTo(thickness, side1 - side3 - side2 + outerRadius)
    shape2.lineTo(0, side1 - side3 - side2 + outerRadius)
    shape2.lineTo(0,side1 - side3 - outerRadius)
    shapes.push(shape2)
  ...
  return (
    <div>
      ...
      <h1 className="heading">Manitou Lip Tube</h1>
      ...
      <div className = "container">
        ...
        <div className='box'>
        <div ref={GraphRef}><Double_center_mullion_graph side11 = {side1} side22={side2} side33={side3} side44={side4} side55={side5} side66={side6} angle1={angle} thickness1={thickness} outerRadius1={outerRadius} sendValue={handleData}/></div>
        </div>
        <div className='box'>
...
export default Double_center_mullion;
