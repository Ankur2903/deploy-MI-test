    ...
    <div>
      ...
      <div className = "container">
        ...
        <div className='box'>
          ...
          <Hollow_guide_rail_graph side11={side1} side22={side2} side33={side3} side44={side4} side55={side5} angle1={angle} radius1={radius} thickness1={thickness} outerRadius1={outerRadius} lAngleGraphRef={lAngleGraphRef} sendValuex={handleComx} sendValuey={handleComy}/></div>
        </div>
        <div className='box'>
