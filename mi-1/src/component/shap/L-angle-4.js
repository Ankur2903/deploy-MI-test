...
function L_angle_4({materials}) {
  ...
  const create3DShapes = () => {
    ...
    shape1.moveTo(side3 ,side1 + side5 - thickness);
    shape1.lineTo(side3 - thickness ,side1 + side5 - thickness);
    shape1.absarc(side3 - outerRadius,side1 + outerRadius - thickness,outerRadius - thickness,0*Math.PI/2,3*Math.PI/2,true);
    ...
    shape1.absarc(side2 + outerRadius - thickness,side4 - outerRadius,outerRadius - thickness,2*Math.PI/2,1*Math.PI/2,true);
    shape1.lineTo(side2 + side6 - thickness,side4 - thickness)
    shape1.lineTo(side2 + side6 - thickness,side4)
    shape1.absarc(side2 + outerRadius - thickness,side4 - outerRadius,outerRadius,1*Math.PI/2,2*Math.PI/2,false);
    ...
    shape1.absarc(side3 - outerRadius,side1 + outerRadius - thickness,outerRadius,3*Math.PI/2,0*Math.PI/2,false);
    shape1.lineTo(side3 ,side1 + side5 - thickness)
    shapes.push(shape1)
  ...
  return (
    <div>
      ...
      <h1 className="heading">Angle-5</h1>
      ...
      <div className = "container">
        ...
        <div className='box'>
          <div ref={GraphRef}><L_angle_4_graph side11={side1} thickness1={thickness} side22={side2} side33={side3} side44={side4} side55={side5} side66={side6} outerRadius1={outerRadius} sendValue={handleData}/></div>
        </div>
        <div className='box'>
