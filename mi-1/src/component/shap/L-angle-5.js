...
function L_angle_5() {
  ...
  return (
    <>
      ...
      <h1 className="heading">L angle 5</h1>
      ...
      <div className = "container">
        ...
        <div className='box'>
          ...
          <L_angle_5_graph side11={side1} thickness1={thickness} side22={side2} side33={side3} side44={side4} outerRadius1={outerRadius} lAngleGraphRef={lAngleGraphRef} sendValuex={handleComx} sendValuey={handleComy}/></div>
        </div>
        <div className='box'>
