...
import Lower_frame_graph from '../Graph/Lower-frame';
...
function Lower_frame() {
  ...
  const [side3, setSide3] = useState(55);
  ...
  const [side6, setSide6] = useState(14);
  const side6Change = (event) => {
    setSide6(parseFloat(event.target.value));
  };
  const [side7, setSide7] = useState(16);
  ...
  const submitClick = () => {
    setWeightPerLenght((7850*(4*Math.PI*(outerRadius - 0.596*thickness) + (side1 - 2*outerRadius) + (side2  - 4*outerRadius + thickness) + (side3  - 4*outerRadius + thickness) + (side6 - outerRadius) + (side7 - outerRadius))*thickness*0.000001).toFixed(3));
  ...
  const create3DShapes = () => {
    ...
    shape1.moveTo(0 ,side2 - thickness)
    shape1.lineTo(0, side2)
    shape1.absarc(side6 - outerRadius, side2 - outerRadius, outerRadius, Math.PI/2, 0, true)
    shape1.absarc(side6 - outerRadius, side2 - side4 + outerRadius, outerRadius, 0, 3*Math.PI/2, true)
    shape1.absarc(side6 - outerRadius, side2 - side4 - outerRadius + thickness, outerRadius - thickness, Math.PI/2, Math.PI, false)
    shape1.absarc(side6 - outerRadius, outerRadius, outerRadius - thickness, Math.PI, 3*Math.PI/2, false)
    shape1.absarc(side6 + side1 - 3*outerRadius, outerRadius, outerRadius - thickness, 3*Math.PI/2, 0, false)
    shape1.absarc(side6 + side1 - 3*outerRadius, side3 - side5 - outerRadius + thickness, outerRadius - thickness, 0, Math.PI/2, false)
    shape1.absarc(side6 + side1 - 3*outerRadius, side3 - side5 + outerRadius, outerRadius, 3*Math.PI/2, Math.PI, true)
    shape1.absarc(side6 + side1 - 3*outerRadius, side3 - outerRadius, outerRadius, Math.PI, Math.PI/2, true)
    shape1.lineTo(side6 - 4*outerRadius + side1 + side7, side3)
    shape1.lineTo(side6 - 4*outerRadius + side1 + side7, side3 - thickness)
    shape1.absarc(side6 + side1 - 3*outerRadius, side3 - outerRadius, outerRadius - thickness, Math.PI/2, Math.PI, false)
    shape1.absarc(side6 + side1 - 3*outerRadius, side3 - side5 + outerRadius, outerRadius - thickness, Math.PI, 3*Math.PI/2, false)
    shape1.absarc(side6 + side1 - 3*outerRadius, side3 - side5 - outerRadius + thickness, outerRadius, Math.PI/2, 0, true)
    shape1.absarc(side6 + side1 - 3*outerRadius, outerRadius, outerRadius,0, 3*Math.PI/2, true)
    shape1.absarc(side6 - outerRadius, outerRadius, outerRadius, 3*Math.PI/2, Math.PI, true)
    shape1.absarc(side6 - outerRadius, side2 - side4 - outerRadius + thickness, outerRadius, Math.PI, Math.PI/2, true)
    shape1.absarc(side6 - outerRadius, side2 - side4 + outerRadius, outerRadius - thickness, 3*Math.PI/2, 0, false)
    shape1.absarc(side6 - outerRadius, side2 - outerRadius, outerRadius - thickness, 0, Math.PI/2, false)
  ...
  const handleDownload = () => {
    ...
    doc.setFontSize(10).setTextColor('black').text(`Side(A): ${side1}   Side(B): ${side2}   Side(C): ${side3}   Side(D): ${side4}   Side(E): ${side5}   Side(F): ${side6}   Side(G): ${side7}   Thickness(t): ${thickness}   Length(L): ${length}`, 6, 30);
  ...
  return (
    <div>
      ...
      <h1 className="heading">Lower Frame</h1>
      ...
      <div className = "container">
        ...
        <div className='box'>
          <div ref={cChannelGraphRef}><Lower_frame_graph side11={side1} side22={side2} side33={side3} side44={side4} side55={side5} side66={side6} side77={side7}thickness1={thickness} outerRadius1={outerRadius} sendValuey={handleComy}/>
        </div></div>
        <div className='box'>
