...
function M_diamond_tube() {
  ...
  const submitClick = () => {
    setWeightPerLength((7850*(2*Math.PI*(outerRadius - 0.596*thickness) + l + (side1 - outerRadius - outerRadius/Math.tan(angle/2)) + (side2 - 2*outerRadius) + (side3 - outerRadius - outerRadius*Math.tan(angle)))*thickness*0.000001).toFixed(3));
  ...
  return (
    <div>
      ...
      <div className = "container">
        ...
        <div className='box'>
        <div ref={GraphRef}><M_diamond_tube_graph side11 = {side1} side22={side2} side33={side3} thickness1={thickness} outerRadius1={outerRadius} sendValue={handleData}/></div>
        </div>
        <div className='box'>
