...
import Rectangle_graph from '../Graph/Rectangle';
import '../../App.css'
...
function Rectangle() {
  ...
  const submitClick = () => {
    setWeightPerLength(((2*(side1 - 2*outerRadius) + 2*(side2 - 2*outerRadius) + 2*Math.PI*(outerRadius - 0.6*thickness))*thickness*7850*0.000001).toFixed(3));

    setTotalWeight(((2*(side1 - 2*outerRadius) + 2*(side2 - 2*outerRadius) + 2*Math.PI*(outerRadius - 0.6*thickness))*thickness*7850*0.000001*length).toFixed(3));

    setStripWidth((2*(side1 - 2*outerRadius) + 2*(side2 - 2*outerRadius) + 2*Math.PI*(outerRadius - 0.596*thickness)).toFixed(3))

    setOutLine((4*(side1 - 2*outerRadius) + 4*(side2 - 2*outerRadius) + 2*Math.PI*(outerRadius -thickness) + 2*Math.PI*(outerRadius) + 2*thickness).toFixed(3))

    setArea((thickness*2*((side1 - 2*outerRadius) + (side2 - 2*outerRadius)) + Math.PI*Math.pow(outerRadius,2) - Math.PI*Math.pow(outerRadius - thickness,2)).toFixed(3))

    // setInertiaX(((4*((Math.pow(outerRadius,4) - Math.pow(outerRadius-thickness,4))*((Math.PI/16) - (4/(9*Math.PI))) + ((Math.PI*(outerRadius - thickness))/4)*(Math.pow((((side2-2*outerRadius)/2) + ((4*(outerRadius-thickness))/(3*Math.PI))),2)) +  ((Math.PI*outerRadius)/4)*(Math.pow((((side2-2*outerRadius)/2) + ((4*outerRadius)/(3*Math.PI))),2)))  +  2*((side1 - 2*outerRadius)*(thickness)*((Math.pow(thickness,2)/12) + (Math.pow((side1/2 - thickness/2),2))))  +  2*((side2 - 2*outerRadius)*(thickness)*(Math.pow((side2-2*outerRadius),2)/12)))*0.0001).toFixed(2))

    // setInertiaY(((4*((Math.pow(outerRadius,4) - Math.pow(outerRadius-thickness,4))*((Math.PI/16) - (4/(9*Math.PI))) + ((Math.PI*(outerRadius - thickness))/4)*(Math.pow((((side1-2*outerRadius)/2) + ((4*(outerRadius-thickness))/(3*Math.PI))),2)) +  ((Math.PI*outerRadius)/4)*(Math.pow((((side1-2*outerRadius)/2) + ((4*outerRadius)/(3*Math.PI))),2)))  +   2*((side2 - 2*outerRadius)*(thickness)*((Math.pow(thickness,2)/12) + (Math.pow((side2/2 - thickness/2),2))))  +  2*((side1 - 2*outerRadius)*(thickness)*(Math.pow((side2-2*outerRadius),2)/12)))*0.0001).toFixed(2))
  };
  ...
  const create3DShapes = () => {
    ...
    shape3.lineTo(0,side2 - outerRadius);
    shape3.lineTo(thickness, side2 - outerRadius)
    shape3.lineTo(thickness, outerRadius)
    shape3.lineTo(0, outerRadius)
    shapes.push(shape3)

    const shape4 = new THREE.Shape();
    shape4.moveTo(outerRadius, side2);
    shape4.lineTo(outerRadius, side2 - thickness);
    shape4.arc(0,-outerRadius + thickness,outerRadius - thickness,1*Math.PI/2,2*Math.PI/2,false)
    shape4.lineTo(0, side2 - outerRadius)
    shape4.arc(outerRadius, 0,outerRadius,2*Math.PI/2,1*Math.PI/2,true)
    shapes.push(shape4)

    const shape5 = new THREE.Shape();
    shape5.moveTo(outerRadius, side2 - thickness);
    shape5.lineTo(outerRadius, side2);
    shape5.lineTo(side1 - outerRadius, side2)
    shape5.lineTo(side1 - outerRadius, side2 - thickness)
    shape5.lineTo(outerRadius, side2 - thickness)
    shapes.push(shape5)

    const shape6 = new THREE.Shape();
    shape6.moveTo(side1, side2 - outerRadius);
    shape6.lineTo(side1 - thickness, side2 - outerRadius);
    shape6.arc(thickness- outerRadius, 0,outerRadius - thickness,0*Math.PI/2,1*Math.PI/2,false)
    shape6.lineTo(side1 - outerRadius, side2)
    shape6.arc(0, - outerRadius,outerRadius,1*Math.PI/2,0*Math.PI/2,true)
    shapes.push(shape6)

    const shape7 = new THREE.Shape();
    shape7.moveTo(side1 - thickness,side2 - outerRadius);
    shape7.lineTo(side1,side2 - outerRadius);
    shape7.lineTo(side1,outerRadius)
    shape7.lineTo(side1 - thickness, outerRadius)
    shape7.lineTo(side1 - thickness,side2 - outerRadius)
    shapes.push(shape7)

    const shape8 = new THREE.Shape();
    shape8.moveTo(side1 - outerRadius, 0);
    shape8.lineTo(side1 - outerRadius, thickness);
    shape8.arc(0, outerRadius - thickness,outerRadius - thickness,3*Math.PI/2,0*Math.PI/2,false)
    shape8.lineTo(side1, outerRadius)
  ...
  return (
    <>
      ...
      <div className = "container">
        ...
        <div className='box'>
          <div ref={rectangleGraphRef}><Rectangle_graph side1={side1} side2={side2} thickness1={thickness} outerRadius1={outerRadius}/></div>
        </div>
        <div className='box'>
