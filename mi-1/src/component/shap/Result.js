...
function Result({weightPerLength, length, totalWeight, stripWidth, outLine, area, inertiax, inertiay}) {
  return (
    <>
    <div style={{ fontWeight: 'bold', textAlign: 'center'}}>Output</div>
        ...
        <p className="output-text" ><b>Radius of gyration i(x):</b><p> ___ cm</p></p>
        ...
        <p className="output-text" ><b>Radius of gyration i(y):</b><p>___ cm</p> </p>
        <p className="output-text" ><b>Centrifugal moment I(xy):</b><p> ___ cm^4</p></p>
        <p className="output-text" ><b>Polar moment of inertia Ip:</b><p> ___ cm^4</p></p>
