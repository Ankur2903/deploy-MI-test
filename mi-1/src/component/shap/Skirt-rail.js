...
import Skirt_rail_graph from '../Graph/Skirt-rail';
import Feasibility from '../Feasibility';
import FeasibilityL1 from '../FeasibilityL1';
import * as Props from '../constant';

function Skirt_rail({materials}) {
  ...
  return (
    <div>
      ...
      <div className = "container">
        ...
        <div className='box'>
        <div ref={GraphRef}><Skirt_rail_graph side11 = {side1} side22={side2} side33={side3} side44={side4} angle11={angle1} angle22={angle2} radius1={radius} thickness1={thickness} outerRadius1={outerRadius} sendValue={handleData}/></div>
        </div>
        <div className='box'>
