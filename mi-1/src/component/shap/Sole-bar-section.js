...
import Sole_bar_section_graph from '../Graph/Sole-bar-section';
import Feasibility from '../Feasibility';
import * as Props from '../constant';

function Sole_bar_section() {
  ...
  const submitClick = () => {
    ...
    setTotalWeight(((2*(side1 - 2*outerRadius) + (side2 - 2*outerRadius + 2*thickness) + (side3 - 2*thickness)  + 2*((side3 - side2)/2 -2*outerRadius) + (side1 - side4 - 2*outerRadius + thickness) + 4*Math.PI*(outerRadius - 0.596*thickness))*thickness*7850*0.000001*length).toFixed(3));

    setStripWidth((2*(side1 - 2*outerRadius) + (side2 - 2*outerRadius + 2*thickness) + (side3 - 2*thickness)  + 2*((side3 - side2)/2 -2*outerRadius) + (side1 - side4 - 2*outerRadius + thickness) + 4*Math.PI*(outerRadius - 0.596*thickness)).toFixed(3))

    setOutLine((4*(side1 - 2*outerRadius) + 2*(side2 - 2*outerRadius + 2*thickness) + 2*(side3 - 2*thickness)  + 4*((side3 - side2)/2 -2*outerRadius) + 2*(side1 - side4 - 2*outerRadius + thickness) + 4*Math.PI*(outerRadius -thickness) + 4*Math.PI*(outerRadius) + 2*thickness).toFixed(3))

    setArea((thickness*(2*(side1 - 2*outerRadius) + (side2 - 2*outerRadius + 2*thickness) + (side3 - 2*thickness)  + 2*((side3 - side2)/2 -2*outerRadius) + (side1 - side4 - 2*outerRadius + thickness)) + Math.PI*Math.pow(outerRadius,2) - Math.PI*Math.pow(outerRadius - thickness,2)).toFixed(3))
  ...
  const create3DShapes = () => {
    ...
    shape1.moveTo(thickness, side1 - outerRadius)
    shape1.lineTo(0, side1 - outerRadius)
    shape1.absarc(outerRadius, side1 - outerRadius, outerRadius,Math.PI, Math.PI/2, true)
    shape1.absarc(side3/2 - side2/2 - outerRadius, side1 - outerRadius, outerRadius, Math.PI/2, 0, true)
    shape1.absarc(side3/2 - side2/2 + outerRadius - thickness, side4 + outerRadius - thickness, outerRadius - thickness, Math.PI, 3*Math.PI/2, false)
    shape1.absarc(side3/2 + side2/2 - outerRadius + thickness, side4 + outerRadius - thickness, outerRadius - thickness, 3*Math.PI/2, 0, false)
    shape1.absarc(side3/2 + side2/2 + outerRadius, side1 - outerRadius, outerRadius, Math.PI, Math.PI/2, true)
    shape1.absarc(side3 - outerRadius, side1 - outerRadius, outerRadius, Math.PI/2, 0, true)
    ...
    shape1.absarc(side3 - outerRadius, side1 - outerRadius, outerRadius - thickness, 0, Math.PI/2, false)
    shape1.absarc(side3/2 + side2/2 + outerRadius, side1 - outerRadius, outerRadius - thickness, Math.PI/2, Math.PI, false)
    shape1.absarc(side3/2 + side2/2 - outerRadius + thickness, side4 + outerRadius - thickness, outerRadius, 0, 3*Math.PI/2, true)
    shape1.absarc(side3/2 - side2/2 + outerRadius - thickness, side4 + outerRadius - thickness, outerRadius, 3*Math.PI/2, Math.PI, true)
    shape1.absarc(side3/2 - side2/2 - outerRadius, side1 - outerRadius, outerRadius - thickness, 0, Math.PI/2, false)
    shape1.absarc(outerRadius, side1 - outerRadius, outerRadius - thickness, Math.PI/2,Math.PI, false)
    shape1.lineTo(thickness, side1 - outLine)
    shapes.push(shape1)
  ...
  return (
    <div>
      ...
      <h1 className="heading">Sole Bar Section</h1>
      ...
      <div className = "container">
        ...
        <div className='box'>
          <div ref={GraphRef}><Sole_bar_section_graph side11={side1} side22={side2} side33 = {side3} side44 = {side4} thickness1={thickness} outerRadius1={outerRadius} sendValue={handleData}/></div>
        </div>
        <div className='box'>
...
export default Sole_bar_section;
