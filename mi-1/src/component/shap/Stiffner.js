...
function Stiffner() {
  ...
  const submitClick = () => {
    ...
    setArea((Math.PI*(Math.pow(outerRadius1,2) - Math.pow(outerRadius1 - thickness,2)) + 2*aa*angle*(Math.pow(outerRadius1,2) - Math.pow(outerRadius1 - thickness,2))  + 2*aa*angle*(Math.pow(outerRadius2,2) - Math.pow(outerRadius2 - thickness,2)) + 2*(side1 - 2*outerRadius2) + 4*(side2 - outerRadius2 - outerRadius1*Math.tan(aa*angle/2)) + 2*(side3 - 2*(side2 - outerRadius1*Math.tan(aa*angle/2) + outerRadius1*Math.sin(aa*angle)  + ((side4 + outerRadius1*Math.cos(aa*angle) - outerRadius1 - (outerRadius2 - thickness)*(1 - Math.cos(aa*angle)))/Math.sin(aa*angle))*Math.cos(aa*angle) + (outerRadius2 - thickness)*Math.sin(aa*angle))) + 4*((side4 + outerRadius1*Math.cos(aa*angle) - outerRadius1 - (outerRadius2 - thickness)*(1 - Math.cos(aa*angle)))/Math.sin(aa*angle))).toFixed(3))
