...
function Support_tube() {
  ...
  const submitClick = () => {
    setWeightPerLenght((7850*(2*Math.PI*(outerRadius - 0.596*thickness) + 2*l + 2*(side3 - outerRadius) + 2*(side1 - 2*outerRadius - l*Math.cos(angle*aa/2)))*thickness*0.000001).toFixed(3));
