  ...
  return (
    <div>
      ...
      <div className = "container">
        ...
        <div className='box'>
        <div ref={GraphRef}><T_shap_1_graph side11 = {side1} side22={side2} side33={side3} side44={side4} angle1={angle} thickness1={thickness} outerRadius11={outerRadius} outerRadius22={outerRadius1} sendValuey={handleComy}/></div>
        </div>
        <div className='box'>
