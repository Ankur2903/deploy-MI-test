...
function Top_hat({materials}) {
  ...
  const create3DShapes = () => {
    ...
    shape1.moveTo(0,side3);
    shape1.lineTo(0,side3 - thickness)
    shape1.lineTo(side1 - outerRadius,side3 - thickness)
    shape1.absarc(side1 - outerRadius,side3 - outerRadius,outerRadius - thickness,1*Math.PI/2,0*Math.PI/2,true);    
    shape1.lineTo(side1 - thickness,outerRadius)
    shape1.absarc(side1 + outerRadius - thickness,outerRadius,outerRadius,2*Math.PI/2,3*Math.PI/2,false);
    shape1.lineTo(side1 + side2 - thickness - outerRadius,0)
    shape1.absarc(side1 + side2 - thickness - outerRadius,outerRadius,outerRadius,3*Math.PI/2,0*Math.PI/2,false);
    shape1.lineTo(side1 + side2 - thickness,side3 - outerRadius)
    shape1.absarc(side1 + side2 - 2*thickness + outerRadius,side3 - outerRadius,outerRadius - thickness,2*Math.PI/2,1*Math.PI/2,true);
    shape1.lineTo(2*side1 + side2 - 2*thickness,side3 - thickness) 
    shape1.lineTo(2*side1 + side2 - 2*thickness,side3) 
    shape1.lineTo(side1 + side2 - 2*thickness + outerRadius,side3)  
    shape1.absarc(side1 + side2 - 2*thickness + outerRadius,side3 - outerRadius,outerRadius,1*Math.PI/2,2*Math.PI/2,false);
    shape1.lineTo(side1 + side2 - 2*thickness,outerRadius)
    shape1.absarc(side1 + side2 - thickness - outerRadius,outerRadius,outerRadius - thickness,0*Math.PI/2,3*Math.PI/2,true);
    shape1.lineTo(side1 + outerRadius - thickness,thickness)
    shape1.absarc(side1 + outerRadius - thickness,outerRadius,outerRadius - thickness,3*Math.PI/2,2*Math.PI/2,true);
    shape1.lineTo(side1,side3 - outerRadius)
    shape1.absarc(side1 - outerRadius,side3 - outerRadius,outerRadius,0*Math.PI/2,1*Math.PI/2,false); 
    shape1.lineTo(0,side3)
    shapes.push(shape1)    
      ...
      <div className = "container">
        <div className='box'>
          ...
          <div className="container1">
            <lable className="label" htmlFor="side">Lip (l) mm</lable>
            <input className="input-field" id="side" type="number" value={side1} onChange={side1Change} placeholder="Enter side" />
          </div>
          <div className="container1">
        ...
        <div className='box'>
          <div ref={GraphRef}><Top_hat_graph side11={side1} side22 = {side3} side33 = {side2} outerRadius1 = {outerRadius} thickness1 = {thickness}  sendValue={handleData}/></div>
        </div>
        <div className='box'>
