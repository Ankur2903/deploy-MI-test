...
function Trapiz_tube({materials}) {
    ...
    <div>
     ...
     <div style={{display: 'flex', justifyContent: 'center', alignItems: 'center', position: 'relative'}}>
      ...
      <div className = "container">
        ...
        <div className='box'>
        <div ref={GraphRef}><Trapiz_tube_graph side11={side1} side22 = {side2} side33 = {side3} side44 = {side4} side55 = {side5} angle1={angle1} angle2={angle2} thickness1={thickness} outerRadius1={outerRadius} sendValue={handleData}/></div>
        </div>
        <div className='box'>
