...
import Triangular_graph from '../Graph/Triangular';
import '../../App.css'
...
function Triangular({materials}) {
  ...
  const create3DShapes = () => {
    ...
    shape1.moveTo(outerRadius,  2*outerRadius + (side - 2*outerRadius)*Math.sin(Math.PI/3));
    shape1.lineTo(outerRadius, 2*outerRadius + (side - 2*outerRadius)*Math.sin(Math.PI/3) - thickness)
    shape1.absarc(outerRadius,outerRadius + (side - 2*outerRadius)*Math.sin(Math.PI/3),outerRadius - thickness,1*Math.PI/2,7*Math.PI/6,false)
    shape1.lineTo(side/2 - (outerRadius - thickness)*Math.sin(Math.PI/3), (outerRadius + thickness)/2)
    shape1.absarc(side/2,outerRadius,outerRadius - thickness,7*Math.PI/6,11*Math.PI/6,false)
    shape1.lineTo(side - outerRadius + (outerRadius - thickness)*Math.cos(Math.PI/6) ,(side - 2*outerRadius)*Math.sin(Math.PI/3) + (outerRadius + thickness)/2)
    shape1.absarc(side - outerRadius,outerRadius + (side - 2*outerRadius)*Math.sin(Math.PI/3),outerRadius - thickness,11*Math.PI/6,1*Math.PI/2,false)
    shape1.lineTo(side - outerRadius, 2*outerRadius + (side - 2*outerRadius)*Math.sin(Math.PI/3))
    shape1.absarc(side - outerRadius,outerRadius + (side - 2*outerRadius)*Math.sin(Math.PI/3),outerRadius,1*Math.PI/2,11*Math.PI/6,true)
    shape1.lineTo(side/2 + outerRadius*Math.sin(Math.PI/3),outerRadius - outerRadius*Math.cos(Math.PI/3))
    shape1.absarc(side/2,outerRadius,outerRadius,11*Math.PI/6,7*Math.PI/6,true)
    shape1.lineTo(outerRadius - outerRadius*Math.cos(Math.PI/6),outerRadius + (side - 2*outerRadius)*Math.sin(Math.PI/3)- outerRadius*Math.sin(Math.PI/6))
    shape1.absarc(outerRadius,outerRadius + (side - 2*outerRadius)*Math.sin(Math.PI/3),outerRadius,7*Math.PI/6,1*Math.PI/2,true)
    shapes.push(shape1)

    const shape2 = new THREE.Shape();
    shape2.moveTo(outerRadius,2*outerRadius + (side - 2*outerRadius)*Math.sin(Math.PI/3))
    shape2.lineTo(side - outerRadius,2*outerRadius + (side - 2*outerRadius)*Math.sin(Math.PI/3))
    shape2.lineTo(side - outerRadius,2*outerRadius + (side - 2*outerRadius)*Math.sin(Math.PI/3) - thickness)
    shape2.lineTo(outerRadius,2*outerRadius + (side - 2*outerRadius)*Math.sin(Math.PI/3) - thickness)
    shapes.push(shape2)
      ...
      <div className = "container">
        <div className='box'>
          ...
          <div className="container1">
            ...
            <input className="input-field" id="side1" type="number" value={side} onChange={sideChange} placeholder="Type something..." />
          </div>
          <div className="container1">
        ...
        <div className='box'>
          <div ref={GraphRef}><Triangular_graph side1={side} outerRadius1 = {outerRadius} thickness1 = {thickness}  sendValue={handleData}/></div>
        </div>
        <div className='box'>
