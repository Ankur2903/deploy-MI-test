...
function U_channel() {
  ...
  const submitClick = () => {
    setWeightPerLength((7850*(Math.PI*(outerRadius - 0.596*thickness) + 2*(side2 - outerRadius) + (side1 - 2*outerRadius))*thickness*0.000001).toFixed(3));
  ...
  return (
    <div>
      ...
      <div className = "container">
        ...
        <div className='box'>
          <div ref={GraphRef}><U_channel_graph side1={side1} side2={side2} thickness1={thickness} outerRadius1={outerRadius}  sendValue={handleData}/></div>
        </div>
        <div className='box'>
