...
function Z_section() {
  ...
  const [side4, setSide4] = useState(4);
  ...
  const submitClick = () => {
    setWeightPerLenght((7850*(2*Math.PI*(outerRadius - 0.596*thickness) + 2*Math.PI*(radius - 0.596*thickness) + 2*(side4 - 2*radius) + 2*(side2 - outerRadius - radius) + 2*(side1 - side4 - 2*outerRadius + thickness))*thickness*0.000001).toFixed(3));

    setTotalWeight(((7850*(2*Math.PI*(outerRadius - 0.596*thickness) + 2*Math.PI*(radius - 0.596*thickness) + 2*(side4 - 2*radius) + 2*(side2 - outerRadius - radius) + 2*(side1 - side4 - 2*outerRadius + thickness))*thickness*0.000001)*length).toFixed(3));

    setStripWidth((2*Math.PI*(outerRadius - 0.596*thickness) + 2*Math.PI*(radius - 0.596*thickness) + 2*(side4 - 2*radius) + 2*(side2 - outerRadius - radius) + 2*(side1 - side4 - 2*outerRadius + thickness)).toFixed(3));

    setOutLine((2*Math.PI*(2*outerRadius - thickness) + 2*Math.PI*(2*radius - thickness) +  4*(side4 - 2*radius) + 4*(side2 - outerRadius - radius) + 4*(side1 - side4 - 2*outerRadius + thickness) +  2*thickness).toFixed(3));

    setArea((thickness*( 2*(side4 - 2*radius) + 2*(side2 - outerRadius - radius) + 2*(side1 - side4 - 2*outerRadius + thickness)) + Math.PI*(Math.pow(outerRadius,2) - Math.pow(outerRadius - thickness,2)) + Math.PI*(Math.pow(radius,2) - Math.pow(radius - thickness,2))).toFixed(3))
  }
  ...
  const create3DShapes = () => {
    ...
    shape1.absarc(side3 - side2 + outerRadius, outerRadius, outerRadius, 3*Math.PI/2, Math.PI, true)
    shape1.absarc(side3 - side2 - outerRadius + thickness, side1 - side4 - outerRadius + thickness, outerRadius - thickness, 0, Math.PI/2, false)
    ...
    shape1.absarc(side3 - side2 - outerRadius + thickness, side1 - side4 - outerRadius + thickness, outerRadius, Math.PI/2, 0, true)
    shape1.absarc(side3 - side2 + outerRadius, outerRadius, outerRadius - thickness, Math.PI, 3*Math.PI/2, false)
  ...
  return (
    <div>
      ...
      <div className = "container">
        ...
        <div className='box'>
          <div ref={cChannelGraphRef}><Z_section_graph side11={side1} side22={side2} side33={side3} side44 = {side4} radius1={radius} thickness1={thickness} outerRadius1={outerRadius} sendValuey={handleComy}/>
        </div></div>
        <div className='box'>
